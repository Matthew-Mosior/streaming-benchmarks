...
(define SystemC-45PosixC-45FileC-45Prim-prim__open (lambda (farg-0 farg-1 farg-2 farg-3) ((foreign-procedure "li_open" (string unsigned-32 integer-32) integer-32) farg-0 farg-1 farg-2)))
...
(define csegen-59 (lambda (eta-0) (vector 1 (DataC-45ByteString-u--fromString_FromString_ByteString eta-0))))
(define csegen-61(delay (cons (lambda (arg-8497) (lambda (arg-8500) (string-append arg-8497 arg-8500))) "")))
...
(define csegen-71 (vector 3 (vector 0 (vector 3 (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO (lambda (eta-1) (vector 1 eta-1)) (lambda (eta-1) (let ((sc0 (SystemC-45PosixC-45FileC-45Prim-fwrite (lambda (eta-2) eta-2) 2 csegen-59 "Usage: pack run idris2-streams-string-search.ipkg [small|medium|large|extra_large]\xa;" 0 eta-1))) (case (vector-ref sc0 0) ((1) 'erased) (else 'erased)))) eta-0))))))
(define csegen-81 (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8912 eta-0)))))) (lambda (u--a) (lambda (arg-9951) (lambda (eta-0) arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (lambda (world-4) (let ((act-5 (arg-9957 world-4))) (let ((act-3 (arg-9964 world-4))) (act-5 act-3))))))))))
(define csegen-88 (cons (vector csegen-81 (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (lambda (world-0) (let ((act-1 (arg-10436 world-0))) ((arg-10439 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10450) (lambda (world-0) (let ((act-1 (arg-10450 world-0))) (act-1 world-0)))))) (lambda (u--a) (lambda (arg-13044) arg-13044))))
(define csegen-92 (vector (lambda (arg-5919) (lambda (arg-5922) (bs+ arg-5919 arg-5922 63))) (lambda (arg-5929) (lambda (arg-5932) (bs* arg-5929 arg-5932 63))) (lambda (arg-5939) (blodwen-toSignedInt arg-5939 63))))
...
(define IOC-45AsyncC-45LoopC-45Posix-submit (lambda (arg-0 arg-1 arg-2) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons "submitting a fiber to " (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) '())))) arg-2))) (let ((eff-1 (IOC-45AsyncC-45LoopC-45Queue-enq (let ((e-3 (vector-ref arg-0 3))) e-3) arg-1 'erased))) (cond ((equal? eff-1 1) (let ((eff-2 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons "waking up " (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) '())))) 'erased))) (let ((eff-3 ((SystemC-45Concurrency-mutexAcquire csegen-88 (let ((e-9 (vector-ref arg-0 9))) e-9)) 'erased))) (let ((eff-4 ((SystemC-45Concurrency-conditionSignal csegen-88 (let ((e-10 (vector-ref arg-0 10))) e-10)) 'erased))) ((SystemC-45Concurrency-mutexRelease csegen-88 (let ((e-9 (vector-ref arg-0 9))) e-9)) 'erased))))) (else 'erased))))))
(define csegen-126 (cons (lambda (u--el) (lambda (arg-1956) (lambda (eta-2) (IOC-45AsyncC-45LoopC-45Posix-submit u--el arg-1956 eta-2)))) 1024))
...
(define DataC-45Vect-u--toList_Foldable_C-40VectC-32C-36nC-41 (lambda (ext-0) (DataC-45Vect-u--foldr_Foldable_C-40VectC-32C-36nC-41 csegen-111 '() ext-0)))
(define csegen-147 (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (DataC-45Vect-u--foldr_Foldable_C-40VectC-32C-36nC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (DataC-45Vect-u--foldl_Foldable_C-40VectC-32C-36nC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10939) (DataC-45Vect-u--null_Foldable_C-40VectC-32C-36nC-41 arg-10939))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (DataC-45Vect-u--foldlM_Foldable_C-40VectC-32C-36nC-41 i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10968) (DataC-45Vect-u--toList_Foldable_C-40VectC-32C-36nC-41 arg-10968))) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10982) (DataC-45Vect-u--foldMap_Foldable_C-40VectC-32C-36nC-41 i_con-0 u--f arg-10982))))))))
(define csegen-161(delay (lambda (arg-1594) (lambda (arg-1597) (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1594 arg-1597)))))
(define csegen-168(delay (vector (cons (lambda (arg-712) (lambda (arg-715) (or (and (= arg-712 arg-715) 1) 0))) (lambda (arg-722) (lambda (arg-725) (let ((sc0 (or (and (= arg-722 arg-725) 1) 0))) (cond ((equal? sc0 1) 0) (else 1)))))) (force csegen-161) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-61C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1604 arg-1607) 0))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-61C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1614 arg-1617) 2))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-47C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1624 arg-1627) 2))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-47C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1634 arg-1637) 0))) (lambda (arg-1644) (lambda (arg-1647) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1644 arg-1647) 2))) (cond ((equal? sc0 1) arg-1644) (else arg-1647))))) (lambda (arg-1654) (lambda (arg-1657) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Ordering (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1654 arg-1657) 0))) (cond ((equal? sc0 1) arg-1654) (else arg-1657))))))))
...
(define csegen-169 (DataC-45SortedMap-empty (force csegen-168)))
(define csegen-170 (vector 1 csegen-169))
...
(define csegen-188 (LanguageC-45ReflectionC-45Derive-mkOrd (cons (lambda (eta-0) (lambda (eta-1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Bits32 eta-0 eta-1))) (lambda (u--a) (lambda (u--b) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Bits32 u--a u--b))) (cond ((equal? sc0 1) 0) (else 1)))))) (lambda (eta-0) (lambda (eta-1) (PreludeC-45EqOrd-u--compare_Ord_Bits32 eta-0 eta-1)))))
(define csegen-192 (vector (lambda (arg-5919) (lambda (arg-5922) (bu+ arg-5919 arg-5922 32))) (lambda (arg-5929) (lambda (arg-5932) (bu* arg-5929 arg-5932 32))) (lambda (arg-5939) (blodwen-toUnsignedInt arg-5939 32))))
...
(define DataC-45ByteString-index (lambda (arg-0 arg-1) (let ((e-0 (car arg-1))) (let ((e-1 (cdr arg-1))) (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) (let ((e-2 (car e-1))) (let ((e-3 (cdr e-1))) (DataC-45BufferC-45Core-prim__getByteOffset e-2 eta-0 e-3)))) (DataC-45ArrayC-45Index-tryNatToFin e-0 arg-0))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32kmpBordersC-44dec-1883 (lambda (arg-2 arg-4 arg-5 arg-6 arg-7 arg-8 arg-9) (let ((u--wj (DataC-45ByteString-index arg-9 arg-4))) (if (null? u--wj) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.kmpBorders.dec: can't index into ByteString") (let ((e-2 (unbox u--wj))) (let ((u--wi (DataC-45ByteString-index (PreludeC-45Types-prim__integerToNat (- arg-7 1)) arg-4))) (if (null? u--wi) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.kmpBorders.dec: can't index into ByteString") (let ((e-3 (unbox u--wi))) (let ((sc2 (or (and (= (PreludeC-45Types-prim__integerToNat e-3) (PreludeC-45Types-prim__integerToNat e-2)) 1) 0))) (cond ((equal? sc2 1) (+ arg-9 1)) (else (let ((sc3 (or (and (= arg-9 0) 1) 0))) (cond ((equal? sc3 1) 0) (else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1795-u--dec arg-2 arg-7 arg-9 arg-4 arg-5 'erased)))))))))))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--kmpBordersC-44dec-1827 (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8) (if (null? arg-8) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.kmpBorders.dec: can't convert Nat to Fin") (let ((e-2 (unbox arg-8))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32kmpBordersC-44dec-1883 arg-2 arg-4 arg-5 arg-6 arg-7 e-2 (DataC-45ArrayC-45Core-prim__arrayGet arg-5 e-2))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1795-u--dec (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7) (cond ((equal? arg-4 0) 0)(else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--kmpBordersC-44dec-1827 arg-2 arg-7 arg-5 arg-6 arg-4 arg-3 (DataC-45ArrayC-45Index-tryNatToFin (+ (let ((e-0 (car arg-5))) e-0) 1) arg-4))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1796-u--go (lambda (arg-2 arg-3 arg-4 arg-5 arg-6) (cond ((equal? arg-3 0) (let ((sc1 (DataC-45ArrayC-45Index-tryNatToFin (+ (let ((e-0 (car arg-4))) e-0) 1) 0))) (if (null? sc1) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.kmpBorders.go: can't convert Nat to Fin") (let ((e-2 (unbox sc1))) (DataC-45ArrayC-45Core-prim__arraySet arg-5 e-2 0 arg-6)))))(else (let ((e-0 (- arg-3 1))) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1796-u--go arg-2 e-0 arg-4 arg-5 arg-6))) (let ((sc0 (DataC-45ArrayC-45Index-tryNatToFin (+ (let ((e-2 (car arg-4))) e-2) 1) (+ e-0 1)))) (if (null? sc0) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.kmpBorders.go: can't convert Nat to Fin") (let ((e-2 (unbox sc0))) (let ((eff-1 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1795-u--dec arg-2 (+ e-0 1) e-0 arg-4 arg-5 'erased))) (DataC-45ArrayC-45Core-prim__arraySet arg-5 e-2 eff-1 'erased)))))))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--kmpBorders-2404 (lambda (arg-2 arg-3) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6060-1796-u--go arg-2 (let ((e-0 (car arg-2))) e-0) arg-2 arg-3 'erased))) arg-3)))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-kmpBorders (lambda (arg-1 arg-2) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--kmpBorders-2404 arg-1 (DataC-45ArrayC-45Core-prim__emptyArray (+ (let ((e-0 (car arg-1))) e-0) 1) arg-2))))
...
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7) (let ((u--idx (+ (* arg-3 256) arg-4))) (let ((sc0 (DataC-45ArrayC-45Index-tryNatToFin (* (+ (let ((e-0 (car arg-5))) e-0) 1) 256) u--idx))) (if (null? sc0) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.automaton.loop: can't convert Nat to Fin") (let ((e-2 (unbox sc0))) e-2))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-2702 (lambda (arg-2 arg-4 arg-5 arg-6 arg-7 arg-8 arg-10 arg-11) (let ((eff-0 (DataC-45ArrayC-45Core-prim__arrayGet arg-5 arg-11))) (DataC-45ArrayC-45Core-prim__arraySet arg-5 arg-8 eff-0 'erased))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-2938 (lambda (arg-2 arg-4 arg-5 arg-6 arg-7 arg-8 arg-10 arg-11 arg-12) (let ((eff-0 (DataC-45ArrayC-45Core-prim__arrayGet arg-5 arg-12))) (DataC-45ArrayC-45Core-prim__arraySet arg-5 arg-8 eff-0 'erased))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3224 (lambda (arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12 arg-14) (let ((eff-0 (DataC-45ArrayC-45Core-prim__arraySet arg-6 arg-9 arg-14 'erased))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 arg-3 arg-8 arg-11 arg-14 arg-5 arg-6 'erased))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3185 (lambda (arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3224 arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12 (DataC-45ArrayC-45Core-prim__arrayGet arg-6 arg-12))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3596 (lambda (arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12 arg-13 arg-15) (let ((eff-0 (DataC-45ArrayC-45Core-prim__arraySet arg-6 arg-9 arg-15 'erased))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 arg-3 arg-8 arg-12 arg-15 arg-5 arg-6 'erased))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3555 (lambda (arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12 arg-13) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3596 arg-2 arg-3 arg-5 arg-6 arg-7 arg-8 arg-9 arg-11 arg-12 arg-13 (DataC-45ArrayC-45Core-prim__arrayGet arg-6 arg-13))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8 arg-9) (cond ((equal? arg-3 0) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-4 0 arg-7 arg-8 arg-9))) (if (null? arg-5) (let ((u--patbyte '())) (let ((sc2 (or (and (= arg-4 0) 1) 0))) (cond ((equal? sc2 1) (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 0 'erased)) (else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-2702 arg-2 arg-7 arg-8 arg-6 arg-4 eff-0 u--patbyte (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-6 0 arg-7 arg-8 'erased)))))) (let ((e-2 (unbox arg-5))) (let ((u--patbyte (box e-2))) (let ((sc2 (or (and (= 0 (PreludeC-45Types-prim__integerToNat e-2)) 1) 0))) (cond ((equal? sc2 1) (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 (+ arg-4 1) 'erased)) (else (let ((sc3 (or (and (= arg-4 0) 1) 0))) (cond ((equal? sc3 1) (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 0 'erased)) (else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-2938 arg-2 arg-7 arg-8 arg-6 arg-4 eff-0 e-2 u--patbyte (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-6 0 arg-7 arg-8 'erased)))))))))))))(else (let ((e-0 (- arg-3 1))) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-4 (+ e-0 1) arg-7 arg-8 arg-9))) (if (null? arg-5) (let ((u--patbyte '())) (let ((sc1 (or (and (= arg-4 0) 1) 0))) (cond ((equal? sc1 1) (let ((eff-1 (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 0 'erased))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 e-0 arg-4 u--patbyte arg-6 arg-7 arg-8 'erased))) (else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3185 arg-2 e-0 arg-7 arg-8 arg-6 arg-4 eff-0 u--patbyte (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-6 (+ e-0 1) arg-7 arg-8 'erased)))))) (let ((e-2 (unbox arg-5))) (let ((u--patbyte (box e-2))) (let ((sc1 (or (and (= (+ e-0 1) (PreludeC-45Types-prim__integerToNat e-2)) 1) 0))) (cond ((equal? sc1 1) (let ((eff-1 (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 (+ arg-4 1) 'erased))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 e-0 arg-4 u--patbyte arg-6 arg-7 arg-8 'erased))) (else (let ((sc2 (or (and (= arg-4 0) 1) 0))) (cond ((equal? sc2 1) (let ((eff-1 (DataC-45ArrayC-45Core-prim__arraySet arg-8 eff-0 0 'erased))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 e-0 arg-4 u--patbyte arg-6 arg-7 arg-8 'erased))) (else (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32automatonC-44loop-3555 arg-2 e-0 arg-7 arg-8 arg-6 arg-4 eff-0 e-2 u--patbyte (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2457-u--flattenIndex arg-2 arg-6 (+ e-0 1) arg-7 arg-8 'erased)))))))))))))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--automatonC-44fillState-3710 (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8) (if (null? arg-8) (Builtin-idris_crash "Data.ByteString.Search.Internal.Utils.automaton.fillState: can't convert Nat to Fin") (let ((e-2 (unbox arg-8))) (let ((eff-0 (DataC-45ArrayC-45Core-prim__arrayGet arg-5 e-2))) (let ((u--patbyte (DataC-45ByteString-index arg-7 arg-4))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2459-u--loop arg-2 255 arg-7 u--patbyte eff-0 arg-4 arg-6 'erased)))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2456-u--fillState (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--automatonC-44fillState-3710 arg-2 arg-7 arg-4 arg-6 arg-5 arg-3 (DataC-45ArrayC-45Index-tryNatToFin (+ (let ((e-0 (car arg-4))) e-0) 1) arg-3))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2458-u--go (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7) (let ((sc0 (PreludeC-45Types-u--C-62_Ord_Nat arg-3 (let ((e-0 (car arg-4))) e-0)))) (cond ((equal? sc0 1) 'erased) (else (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2456-u--fillState arg-2 arg-3 arg-4 arg-5 arg-6 arg-7))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2458-u--go arg-2 (+ arg-3 1) arg-4 arg-5 arg-6 'erased)))))))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32automaton-3923 (lambda (arg-2 arg-3 arg-5) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-n--6840-2458-u--go arg-2 0 arg-2 arg-3 arg-5 'erased))) arg-3)))
(define DataC-45ByteStringC-45SearchC-45InternalC-45Utils-automaton (lambda (arg-1 arg-2) (let ((eff-0 (DataC-45ArrayC-45Core-prim__emptyArray (* (+ (let ((e-0 (car arg-1))) e-0) 1) 256) arg-2))) (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-case--caseC-32blockC-32inC-32automaton-3923 arg-1 eff-0 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-kmpBorders arg-1 'erased)))))
(define DataC-45ByteVect-n--6358-2853-u--go (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (cond ((equal? arg-3 0) '())(else (let ((e-0 (- arg-3 1))) (let ((sc0 (arg-2 (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (DataC-45BufferC-45Core-prim__getByteOffset e-2 arg-4 e-3)))))) (cond ((equal? sc0 1) (box arg-4)) (else (DataC-45ByteVect-n--6358-2853-u--go arg-0 arg-1 arg-2 e-0 (+ arg-4 1))))))))))
(define DataC-45ByteVect-findIndex (lambda (arg-0 arg-1 arg-2) (DataC-45ByteVect-n--6358-2853-u--go arg-0 arg-2 arg-1 arg-0 0)))
...
(define DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32matcherC-44match-2362 (lambda (arg-2 arg-3 arg-4 arg-6 arg-7 arg-8 arg-9 arg-10 arg-11 arg-12 arg-13 arg-14 arg-15 arg-16 arg-17) (let ((u--nxtidx (+ arg-11 1))) (let ((sc0 (or (and (= arg-17 (let ((e-0 (car arg-7))) e-0)) 1) 0))) (cond ((equal? sc0 1) (let ((u--finalC-39 (PreludeC-45Types-prim__integerToNat (- u--nxtidx (let ((e-0 (car arg-7))) e-0))))) (let ((u--finalC-39C-39 (cons arg-9 u--finalC-39))) (cond ((equal? arg-6 1) (let ((u--ams (+ (PreludeC-45Types-prim__integerToNat (- u--nxtidx (let ((e-0 (car arg-7))) e-0))) 1))) (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 0 u--ams arg-7 arg-10 u--finalC-39C-39 arg-8 arg-6 'erased))) (else (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 0 u--nxtidx arg-7 arg-10 u--finalC-39C-39 arg-8 arg-6 'erased)))))) (else (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 arg-17 u--nxtidx arg-7 arg-10 arg-9 arg-8 arg-6 'erased)))))))
(define DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32matcherC-44match-2276 (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8 arg-9 arg-10 arg-11 arg-12 arg-13 arg-14 arg-15 arg-16) (if (null? arg-16) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher:match: can't convert Nat to Fin") (let ((e-2 (unbox arg-16))) (DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32matcherC-44match-2362 arg-2 arg-3 arg-4 arg-6 arg-7 arg-8 arg-9 arg-10 arg-11 arg-12 arg-13 arg-14 arg-15 e-2 (DataC-45ArrayC-45Core-prim__arrayGet arg-8 e-2))))))
(define DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match (lambda (arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8 arg-9 arg-10 arg-11 arg-12) (cond ((equal? arg-5 0) (let ((sc1 (or (and (= arg-6 (let ((e-0 (car arg-8))) e-0)) 1) 0))) (cond ((equal? sc1 1) arg-9) (else (let ((u--idxC-39 (DataC-45ByteString-index arg-6 arg-8))) (if (null? u--idxC-39) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher:match: can't index into ByteString") (let ((e-2 (unbox u--idxC-39))) (let ((u--patzero (DataC-45ByteString-index 0 arg-7))) (if (null? u--patzero) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher:match: can't index into ByteString") (let ((e-3 (unbox u--patzero))) (let ((sc4 (PreludeC-45EqOrd-u--C-61C-61_Eq_Bits8 e-2 e-3))) (cond ((equal? sc4 1) (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 1 (+ arg-6 1) arg-7 arg-8 arg-9 arg-10 arg-11 arg-12)) (else (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 0 (+ arg-6 1) arg-7 arg-8 arg-9 arg-10 arg-11 arg-12))))))))))))))(else (let ((sc0 (or (and (= arg-6 (let ((e-0 (car arg-8))) e-0)) 1) 0))) (cond ((equal? sc0 1) arg-9) (else (let ((u--idxC-39 (DataC-45ByteString-index arg-6 arg-8))) (if (null? u--idxC-39) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher:match: can't index into ByteString") (let ((e-2 (unbox u--idxC-39))) (let ((u--nstateidx (+ (* arg-5 256) (PreludeC-45Types-prim__integerToNat e-2)))) (let ((idxC-39-0 (box e-2))) (DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32matcherC-44match-2276 arg-2 arg-3 arg-4 arg-12 arg-11 arg-7 arg-10 arg-9 arg-8 arg-6 arg-5 e-2 idxC-39-0 u--nstateidx (DataC-45ArrayC-45Index-tryNatToFin (* (+ (let ((e-0 (car arg-7))) e-0) 1) 256) u--nstateidx))))))))))))))
(define DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32matcher-2733 (lambda (arg-2 arg-3 arg-4 arg-5) (let ((eff-0 (DataC-45ByteStringC-45SearchC-45DFA-n--6219-1803-u--match arg-2 arg-3 arg-4 0 0 arg-3 arg-2 '() arg-5 arg-4 'erased))) (PreludeC-45TypesC-45SnocList-C-60C-62C-62 eff-0 '()))))
(define DataC-45ByteStringC-45SearchC-45DFA-matcher (lambda (arg-1 arg-2 arg-3 arg-4) (let ((sc0 (or (and (= (let ((e-0 (car arg-2))) e-0) 1) 1) 0))) (cond ((equal? sc0 1) (let ((u--patzero (DataC-45ByteString-index 0 arg-2))) (if (null? u--patzero) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher: can't index into ByteString") (let ((e-2 (unbox u--patzero))) (let ((u--headelem (let ((e-0 (car arg-2))) (let ((e-1 (cdr arg-2))) (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) eta-0) (DataC-45ByteVect-findIndex e-0 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Bits8 e-2 arg-0)) e-1)))))) (if (null? u--headelem) (Builtin-idris_crash "Data.ByteString.Search.DFA.matcher: byte does not appear in ByteString") (let ((e-3 (unbox u--headelem))) (cons e-3 '())))))))) (else (DataC-45ByteStringC-45SearchC-45DFA-case--caseC-32blockC-32inC-32matcher-2733 arg-3 arg-2 arg-1 (DataC-45ByteStringC-45SearchC-45InternalC-45Utils-automaton arg-2 arg-4)))))))
(define DataC-45ByteStringC-45SearchC-45DFA-indicesDFA (lambda (arg-1 arg-2 arg-5) (DataC-45ByteStringC-45SearchC-45DFA-matcher 1 arg-1 arg-2 arg-5)))
...
(define DataC-45String-joinBy (lambda (arg-0 arg-1) (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (DataC-45List-intersperse arg-0 arg-1))))
...
(define DataC-45ByteString-null (lambda (arg-0) (if (null? arg-0) 0 (let ((e-0 (car arg-0))) (cond ((equal? e-0 0) 1)(else 0))))))
...
(define Main-searchForATAAA (lambda (arg-0) (let ((u--pat (PreludeC-45Types-fastUnpack "ATAAA"))) (let ((u--patbs (cons (PreludeC-45TypesC-45List-lengthTR (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (cast-char-boundedUInt eta-0 8)) u--pat)) (DataC-45ByteVect-pack (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (cast-char-boundedUInt eta-0 8)) u--pat))))) (let ((sc0 (DataC-45So-decSo (let ((sc1 (DataC-45ByteString-null u--patbs))) (cond ((equal? sc1 1) 0) (else 1)))))) (case (vector-ref sc0 0) ((1) (Builtin-idris_crash "pat is null")) (else (let ((sc1 (DataC-45So-decSo (let ((sc2 (DataC-45ByteString-null arg-0))) (cond ((equal? sc2 1) 0) (else 1)))))) (case (vector-ref sc1 0) ((1) (Builtin-idris_crash "target is null")) (else (let ((u--indices (DataC-45LinearC-45Token-run1 (lambda (s-1296) (lambda (u--t) (DataC-45ByteStringC-45SearchC-45DFA-indicesDFA u--patbs arg-0 u--t)))))) (DataC-45ByteString-u--fromString_FromString_ByteString (DataC-45String-joinBy "," (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45Show-u--show_Show_Nat eta-0)) u--indices))))))))))))))
...
(define Main-search (lambda (arg-0 arg-1) (FSC-45Posix-writeTo csegen-2 0 (lambda (eta-0) (vector 1 eta-0)) (lambda (eta-0) eta-0) 1 (FSC-45Pull-mapMaybe (lambda (eta-0) (box (Main-searchForATAAA eta-0))) (vector 7 '() (FSC-45Resource-bracketWeak (vector 3 (lambda (eta-0) (DataC-45LinearC-45ELift1-toResult (SystemC-45PosixC-45Errno-case--toVal-3852 0 (lambda (eta-1) (SystemC-45PosixC-45FileC-45Prim-prim__open arg-1 0 0 eta-1)) (lambda (eta-1) (blodwen-toUnsignedInt eta-1 32)) (SystemC-45PosixC-45FileC-45Prim-prim__open arg-1 0 0 eta-0))))) (lambda (eta-0) (vector 3 (lambda (eta-1) (DataC-45LinearC-45ELift1-toResult (let ((eff-0 (let ((eff-0 (SystemC-45PosixC-45FileC-45Prim-prim__close eta-0 eta-1))) 'erased))) (vector 1 eff-0 'erased)))))) (lambda (u--fd) (FSC-45Pull-unfoldEvalMaybe (vector 0 (IOC-45AsyncC-45Posix-readnb 0 csegen-2 (lambda (eta-0) eta-0) u--fd (lambda (eta-0) (lambda (eta-1) (let ((e-0 (car eta-0))) (let ((e-1 (cdr eta-0))) (DataC-45ByteString-unsafeByteString (PreludeC-45Types-prim__integerToNat e-0) e-1))))) 65535) (lambda (eta-0) (vector 1 (DataC-45ByteString-nonEmpty eta-0))))))))))))
...
(define FSC-45Scope-getRoot (lambda (arg-2 arg-3 arg-4 ext-0) (DataC-45Maybe-fromMaybe (lambda () (vector (vector arg-4 arg-4 '() '() arg-3 arg-2) '() (force csegen-223))) (DataC-45SortedMap-lookup arg-4 ext-0))))
...
(define IOC-45AsyncC-45LoopC-45Poller-case--dieOnErr-13230 (lambda (arg-2 arg-3) (case (vector-ref arg-3 0) ((1) (let ((e-3 (vector-ref arg-3 1))) e-3)) (else (let ((e-8 (vector-ref arg-3 1))) (let ((e-9 (vector-ref arg-3 2))) (let ((e-14 (vector-ref e-8 1))) ((System-die csegen-88 (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons "Error: " (cons (SystemC-45PosixC-45ErrnoC-45Type-errorText e-14) (cons " (" (cons (SystemC-45PosixC-45ErrnoC-45Type-errorName e-14) (cons ")" '()))))))) e-9))))))))
...
(define SystemC-45PosixC-45SignalC-45Struct-signals (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) eta-0) (let ((sc0 (let ((sc1 csegen-188)) (let ((e-4 (vector-ref sc1 3))) ((e-4 64) 31))))) (cond ((equal? sc0 1) (PreludeC-45Types-u--rangeFromTo_Range_C-36a csegen-210 1 64)) (else (PreludeC-45Types-u--rangeFromTo_Range_C-36a csegen-210 1 31))))))
...
(define IOC-45AsyncC-45LoopC-45Posix-stealTasks (lambda (arg-0 arg-1 arg-2 arg-3) (cond ((equal? arg-2 0) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " could not steal anything" '())))) arg-3))) '()))(else (let ((e-0 (- arg-2 1))) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Queue-steal (let ((sc0 (DataC-45ArrayC-45Core-prim__arrayGet (let ((e-4 (vector-ref arg-0 4))) e-4) arg-1))) (let ((e-3 (vector-ref sc0 3))) e-3)) arg-3))) (if (null? eff-0) (IOC-45AsyncC-45LoopC-45Posix-stealTasks arg-0 (IOC-45AsyncC-45LoopC-45Posix-nextFin (let ((e-11 (vector-ref arg-0 0))) e-11) arg-1) e-0 'erased) (let ((e-6 (unbox eff-0))) (let ((eff-1 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " stole a fiber from " (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 arg-1) (cons " " '())))))) 'erased))) (box e-6))))))))))
(define IOC-45AsyncC-45LoopC-45Posix-case--next-2102 (lambda (arg-0 arg-2) (if (null? arg-2) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Queue-dec (let ((e-6 (vector-ref arg-0 6))) e-6) 'erased))) (cond ((equal? eff-0 0) (let ((eff-1 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " enough stealers are active" '())))) 'erased))) '())) (else (let ((eff-1 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " start stealing" '())))) 'erased))) (let ((eff-2 (IOC-45AsyncC-45LoopC-45Posix-stealTasks arg-0 (IOC-45AsyncC-45LoopC-45Posix-nextFin (let ((e-0 (vector-ref arg-0 0))) e-0) (let ((e-1 (vector-ref arg-0 1))) e-1)) (DataC-45Nat-pred (let ((e-0 (vector-ref arg-0 0))) e-0)) 'erased))) (let ((eff-3 (IOC-45AsyncC-45LoopC-45Queue-inc (let ((e-6 (vector-ref arg-0 6))) e-6) 'erased))) eff-2)))))) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " still got work to do" '())))) 'erased))) arg-2))))
...
(define DataC-45SortedMap-u--toList_Foldable_C-40SortedMapC-32C-36kC-41 (lambda (ext-0) (DataC-45SortedMap-u--foldr_Foldable_C-40SortedMapC-32C-36kC-41 csegen-111 '() ext-0)))
...
(define IOC-45AsyncC-45Loop-asynchronous (lambda (arg-2 arg-3) (IOC-45AsyncC-45Loop-case--asynchronous-3118 arg-2 (box csegen-170))))
(define IOC-45AsyncC-45Loop-newFiber (lambda (arg-2) (let ((eff-0 (DataC-45LinearC-45Unique-token1 arg-2))) (let ((eff-1 (box (vector 0 )))) (let ((eff-2 (box csegen-170))) (vector eff-0 eff-1 eff-2))))))
...
(define IOC-45AsyncC-45LoopC-45Posix-runTask (lambda (arg-0 arg-1 arg-2) (IOC-45AsyncC-45LoopC-45Posix-case--runTask-2344 arg-0 arg-1 (IOC-45AsyncC-45Loop-runFbr csegen-126 arg-0 arg-1 arg-2))))
...
(define IOC-45AsyncC-45LoopC-45Posix-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32loop-2504 (lambda (arg-0 arg-3 arg-4 arg-5 arg-7) (if (null? arg-7) (let ((eff-0 (IOC-45AsyncC-45LoopC-45SignalST-checkSignals (let ((e-8 (vector-ref arg-0 8))) e-8) 'erased))) (let ((eff-1 ((SystemC-45Concurrency-mutexAcquire csegen-88 (let ((e-9 (vector-ref arg-0 9))) e-9)) 'erased))) (let ((eff-2 (IOC-45AsyncC-45LoopC-45Queue-deqAndSleep (let ((e-3 (vector-ref arg-0 3))) e-3) 'erased))) (if (null? eff-2) (let ((u--d (IOC-45AsyncC-45LoopC-45Posix-sleepDuration arg-5))) (let ((eff-3 (IOC-45AsyncC-45LoopC-45Posix-debug (lambda () (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-0) eta-0) (cons (DataC-45Fin-u--show_Show_C-40FinC-32C-36nC-41 (let ((e-1 (vector-ref arg-0 1))) e-1)) (cons " sleeping for " (cons (PreludeC-45Show-u--show_Show_Int u--d) (cons " us" '())))))) 'erased))) (let ((eff-4 ((SystemC-45Concurrency-conditionWaitTimeout csegen-88 (let ((e-10 (vector-ref arg-0 10))) e-10) (let ((e-9 (vector-ref arg-0 9))) e-9) u--d) 'erased))) (let ((eff-5 ((SystemC-45Concurrency-mutexRelease csegen-88 (let ((e-9 (vector-ref arg-0 9))) e-9)) 'erased))) (IOC-45AsyncC-45LoopC-45Posix-loop arg-0 IOC-45AsyncC-45LoopC-45Posix-POLL_ITER 'erased))))) (let ((e-5 (unbox eff-2))) (let ((eff-3 ((SystemC-45Concurrency-mutexRelease csegen-88 (let ((e-9 (vector-ref arg-0 9))) e-9)) 'erased))) (let ((eff-4 (IOC-45AsyncC-45LoopC-45Posix-runTask arg-0 e-5 'erased))) (IOC-45AsyncC-45LoopC-45Posix-loop arg-0 IOC-45AsyncC-45LoopC-45Posix-POLL_ITER 'erased)))))))) (let ((e-5 (unbox arg-7))) (let ((eff-0 (IOC-45AsyncC-45LoopC-45Posix-runTask arg-0 e-5 'erased))) (IOC-45AsyncC-45LoopC-45Posix-loop arg-0 arg-3 'erased))))))
...
(define IOC-45AsyncC-45LoopC-45SignalST-sighandler (lambda (arg-0) (box (cons 0 csegen-218))))
...
(define IOC-45AsyncC-45LoopC-45TimerST-timer (lambda (arg-0) (box (cons 0 (DataC-45SortedMap-empty (vector (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer arg-722 arg-725)))) (force csegen-161) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-60_Ord_Integer arg-1604 arg-1607))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-62_Ord_Integer arg-1614 arg-1617))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-60C-61_Ord_Integer arg-1624 arg-1627))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-62C-61_Ord_Integer arg-1634 arg-1637))) (lambda (arg-1644) (lambda (arg-1647) (PreludeC-45EqOrd-u--max_Ord_Integer arg-1644 arg-1647))) (lambda (arg-1654) (lambda (arg-1657) (PreludeC-45EqOrd-u--min_Ord_Integer arg-1654 arg-1657)))))))))
(define IOC-45AsyncC-45LoopC-45Posix-workST (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 ext-0) (let ((eff-0 (box 1))) (let ((eff-1 (IOC-45AsyncC-45LoopC-45TimerST-timer 'erased))) (let ((eff-2 (IOC-45AsyncC-45LoopC-45SignalST-sighandler 'erased))) (let ((eff-3 (box (vector 0 '() '())))) (let ((eff-4 ((SystemC-45Concurrency-makeMutex csegen-88) 'erased))) (let ((eff-5 ((SystemC-45Concurrency-makeCondition csegen-88) 'erased))) (vector arg-0 arg-1 eff-0 eff-3 arg-3 arg-2 arg-4 eff-1 eff-2 eff-4 eff-5)))))))))
...
(define IOC-45AsyncC-45LoopC-45Posix-app (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (let ((act-1 (IOC-45AsyncC-45LoopC-45Posix-toIO (lambda (eta-0) (SystemC-45PosixC-45SignalC-45Struct-withSignals arg-1 (lambda (u--p) (lambda (es-13228) (lambda (conArg-13229) (lambda (u--t) (let ((eff-0 (SystemC-45PosixC-45SignalC-45Prim-prim__sigprocmask1 0 u--p u--t))) (vector 1 'erased 'erased)))))) 0 eta-0)) ext-0))) (let ((act-2 (IOC-45AsyncC-45LoopC-45Poller-dieOnErr (lambda (eta-0) (SystemC-45PosixC-45FileC-45Prim-addFlags (lambda (eta-1) eta-1) 0 2048 0 eta-0)) ext-0))) (let ((act-3 ((IOC-45AsyncC-45LoopC-45Posix-mkThreadPool arg-0 arg-2) ext-0))) (let ((act-4 (IOC-45AsyncC-45Loop-runAsyncWith csegen-126 (DataC-45Vect-head (let ((e-3 (vector-ref act-3 3))) e-3)) arg-3 (lambda (_-3562) (lambda (eta-0) (IOC-45AsyncC-45LoopC-45Posix-stop act-3 eta-0))) ext-0))) (let ((act-5 (IOC-45AsyncC-45LoopC-45Posix-loop (DataC-45Vect-head (let ((e-3 (vector-ref act-3 3))) e-3)) IOC-45AsyncC-45LoopC-45Posix-POLL_ITER ext-0))) (let ((act-6 (((PreludeC-45Interfaces-traverse_ csegen-81 csegen-147 (lambda (u--x) (lambda (eta-0) (PreludeC-45IO-threadWait u--x eta-0)))) (let ((e-1 (vector-ref act-3 1))) e-1)) ext-0))) (let ((act-7 (((PreludeC-45Interfaces-traverse_ csegen-81 csegen-147 (lambda (u--w) (lambda (eta-0) (IOC-45AsyncC-45LoopC-45Posix-release u--w eta-0)))) (let ((e-3 (vector-ref act-3 3))) e-3)) ext-0))) (let ((act-8 (PreludeC-45IO-threadWait (let ((e-2 (vector-ref act-3 2))) e-2) ext-0))) ((System-usleep csegen-88 (blodwen-toSignedInt 100 63) 'erased) ext-0)))))))))))
...
(define IOC-45AsyncC-45LoopC-45Posix-asyncThreads (lambda (ext-0) (let ((act-1 ((System-getEnv csegen-88 "IDRIS2_ASYNC_THREADS") ext-0))) (let ((sc0 (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) (PreludeC-45Types-prim__integerToNat (cast-string-int eta-0))) act-1))) (if (null? sc0) 2 (let ((e-1 (unbox sc0))) (cond ((equal? e-1 0) 2)(else (let ((e-2 (- e-1 1))) (+ e-2 1))))))))))
...
(define IOC-45AsyncC-45LoopC-45Posix-n--12782-3714-u--cprog (lambda (arg-0 arg-1 arg-2) (IOC-45AsyncC-45Util-race (lambda () 'erased) (cons arg-2 (cons (ControlC-45MonadC-45MErr-handleErrors csegen-24 (lambda (eta-0) (vector 1 'erased)) (vector 0 (vector 0 (IOC-45AsyncC-45Signal-awaitSignals 0 (lambda (arg-880) (lambda (arg-883) (lambda (arg-886) (lambda (eta-0) (IOC-45AsyncC-45LoopC-45SignalST-await (let ((e-8 (vector-ref arg-880 8))) e-8) arg-883 (lambda (eta-1) (arg-886 (vector 1 eta-1))) eta-0))))) (PreludeC-45Types-u--pure_Applicative_List 2)) (lambda (eta-0) (vector 1 'erased))) (lambda (_-10677) (vector 1 'erased)))) '())))))
...
(define FSC-45Scope-u--combineInterrupts_Target_World_C-40AsyncC-32C-36eC-41 (lambda (arg-1 arg-2 arg-3) (if (null? arg-1) (cons arg-2 '()) (if (null? arg-2) (cons arg-1 '()) (let ((e-2 (unbox arg-1))) (let ((e-5 (unbox arg-2))) (FSC-45Scope-case--combineInterrupts-4755 e-2 e-5 (box csegen-170))))))))
...
(define Main-runProg (lambda (arg-0 ext-0) (IOC-45AsyncC-45LoopC-45Posix-simpleApp (cons 2 '()) 0 (FSC-45Core-mpull (vector csegen-24 (lambda (u--es) (vector 4 )) (lambda (u--a) (lambda (u--es) (lambda (u--body) (vector 6 (lambda (u--t) (lambda (u--n) (u--body (lambda (es-5036) (lambda (a-5037) (lambda (eta-0) (vector 13 u--t u--n eta-0))))))))))) (lambda (u--a) (lambda (u--es) (lambda (arg-4914) (lambda (arg-4917) (vector 5 arg-4914 arg-4917)))))) (vector (cons csegen-24 (lambda (u--a) (lambda (u--es) (lambda (arg-4026) (vector 3 (lambda (eta-0) (DataC-45LinearC-45ELift1-toResult (arg-4026 eta-0)))))))) (lambda (u--x) (lambda (u--y) (lambda (eta-0) (FSC-45Scope-u--combineInterrupts_Target_World_C-40AsyncC-32C-36eC-41 u--x u--y eta-0)))) (lambda (arg-4305) (FSC-45Scope-u--isInterrupted_Target_World_C-40AsyncC-32C-36eC-41 arg-4305)) (lambda (u--a) (lambda (u--es) (lambda (arg-4314) (lambda (arg-4318) (FSC-45Scope-u--raceInterrupt_Target_World_C-40AsyncC-32C-36eC-41 arg-4314 arg-4318)))))) (cons (lambda (arg-8497) (lambda (arg-8500) 'erased)) 'erased) (ControlC-45MonadC-45MErr-handleErrors (vector (lambda (u--a) (lambda (u--es) (lambda (arg-3645) (vector 1 arg-3645)))) (lambda (u--es) (lambda (u--a) (lambda (arg-3651) (vector 0 arg-3651)))) (lambda (u--fs) (lambda (u--a) (lambda (u--es) (lambda (arg-3657) (vector 5 arg-3657))))) (lambda (u--b) (lambda (u--a) (lambda (u--es) (lambda (arg-3663) (lambda (arg-3666) (vector 6 arg-3663 arg-3666)))))) (lambda (u--es) (lambda (u--b) (lambda (u--a) (lambda (arg-3677) (lambda (arg-3684) (vector 6 arg-3684 (lambda (eta-0) (vector 0 (arg-3677 eta-0))))))))) (lambda (u--b) (lambda (u--a) (lambda (u--es) (lambda (arg-3691) (lambda (arg-3698) (vector 6 arg-3691 (lambda (arg-1) (vector 6 arg-3698 (lambda (eta-0) (vector 0 (arg-1 eta-0)))))))))))) (lambda (eta-0) (DataC-45ListC-45QuantifiersC-45ExtraC-45Any-collapse (lambda (v-9726) (lambda (eta-1) eta-1)) (DataC-45ListC-45QuantifiersC-45ExtraC-45Any-hzipWith (lambda (v-5258) (lambda (eta-1) eta-1)) (cons (lambda (eta-1) (vector 3 (vector 0 (vector 3 (lambda (eta-2) (PreludeC-45IO-u--map_Functor_IO (lambda (eta-3) (vector 1 eta-3)) (lambda (eta-3) (let ((sc0 (SystemC-45PosixC-45FileC-45Prim-fwrite (lambda (eta-4) eta-4) 2 csegen-59 (string-append (PreludeC-45Types-u--foldMap_Foldable_List (force csegen-61) (lambda (eta-4) eta-4) (cons (SystemC-45PosixC-45ErrnoC-45Type-errorText eta-1) (cons " (" (cons (SystemC-45PosixC-45ErrnoC-45Type-errorName eta-1) (cons ")" '()))))) "\xa;") 0 eta-3))) (case (vector-ref sc0 0) ((1) 'erased) (else 'erased)))) eta-2)))))) '()) eta-0))) arg-0)) ext-0)))
(define FSC-45Chunk-case--fromInteger-2779 (lambda (arg-0 arg-1) (cond ((equal? arg-1 0) 1)(else arg-1))))
(define FSC-45Chunk-fromInteger (lambda (arg-0) (FSC-45Chunk-case--fromInteger-2779 arg-0 (PreludeC-45Types-prim__integerToNat arg-0))))
(define Main-prog (lambda (arg-0) (if (null? arg-0) (vector 1 (DataC-45ListC-45QuantifiersC-45Extra-inject 0 22)) (let ((e-3 (cdr arg-0))) (if (null? e-3) csegen-71 (let ((e-1 (car e-3))) (let ((e-4 (cdr e-3))) (cond ((equal? e-1 "small") (if (null? e-4) (Main-search (FSC-45Chunk-fromInteger 4096) "../resources/nucleotides_small.txt") csegen-71)) ((equal? e-1 "medium") (if (null? e-4) (Main-search (FSC-45Chunk-fromInteger 8192) "../resources/nucleotides_medium.txt") csegen-71)) ((equal? e-1 "large") (if (null? e-4) (Main-search (FSC-45Chunk-fromInteger 16384) "../resources/nucleotides_large.txt") csegen-71)) ((equal? e-1 "extra_large") (if (null? e-4) (Main-search (FSC-45Chunk-fromInteger 32768) "../resources/nucleotides_extra_large.txt") csegen-71))(else csegen-71)))))))))
...
(define System-getArgs (lambda (arg-1) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (System-prim__getArgCount eta-0))))) (lambda (u--n) (let ((sc1 (PreludeC-45EqOrd-u--C-62_Ord_Int u--n (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (PreludeC-45Basics-flip (lambda (arg-14091) (lambda (arg-14098) (PreludeC-45Types-u--traverse_Traversable_List (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) e-10)) arg-14091 arg-14098))) (PreludeC-45Types-u--rangeFromTo_Range_C-36a (cons (vector csegen-92 (lambda (arg-6334) (lambda (arg-6337) (PreludeC-45Num-u--div_Integral_Int arg-6334 arg-6337))) (lambda (arg-6344) (lambda (arg-6347) (PreludeC-45Num-u--mod_Integral_Int arg-6344 arg-6347)))) (cons (vector (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Int arg-722 arg-725)))) (lambda (arg-1594) (lambda (arg-1597) (PreludeC-45EqOrd-u--compare_Ord_Int arg-1594 arg-1597))) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-60_Ord_Int arg-1604 arg-1607))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-62_Ord_Int arg-1614 arg-1617))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-60C-61_Ord_Int arg-1624 arg-1627))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-62C-61_Ord_Int arg-1634 arg-1637))) (lambda (arg-1644) (lambda (arg-1647) (PreludeC-45EqOrd-u--max_Ord_Int arg-1644 arg-1647))) (lambda (arg-1654) (lambda (arg-1657) (PreludeC-45EqOrd-u--min_Ord_Int arg-1654 arg-1657)))) (vector csegen-92 (lambda (arg-6034) (bs- 0 arg-6034 63)) (lambda (arg-6040) (lambda (arg-6043) (bs- arg-6040 arg-6043 63)))))) 0 (bs- u--n 1 63)) (lambda (eta-0) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-1) (System-prim__getArg eta-0 eta-1))))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) '())))))))))))))
(define Main-main (lambda (ext-0) (let ((act-1 ((System-getArgs csegen-88) ext-0))) (Main-runProg (Main-prog act-1) ext-0))))
